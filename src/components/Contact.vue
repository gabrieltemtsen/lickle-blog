<template>
<div><h5>lickle-blog <i class="fa fa-caret-right">Contact </i></h5></div>
...
<div class="row tm-row tm-mb-120">
                ...
                <div class="col-lg-5 tm-contact-right">
                    <address class="mb-4 tm-color-gray">
                        Seventh Avenue Atiku-Junction
                    </address>
                    <span class="d-block">
                        Tel:
                        <a href="tel:060-070-0980" class="tm-color-gray">060-123-789-112</a>
                    </span>
                    <span class="mb-4 d-block">
                        Email:
                        <a href="mailto:info@company.com" class="tm-color-gray">support@lickle-blog.com</a>
                    </span>
